...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        return CookieExtension.CheckValidCookies(SecurityExtension.BuildPassword(UsersColumns.VuAccount));
    }
    ...
    public override void SetConfig()
    {
        ...
        var path = "pic/general";
        if (Session["CKFinderUploadPath"] != null) path = Session["CKFinderUploadPath"].ToString();
        // Lấy path được truyền vào từ querystring
        if (Request.QueryString["path"] != null) path = Request.QueryString["path"];
        BaseUrl = "~/" + path + "/";
        // The physical directory in the server where the file will end up. If blank, CKFinder attempts to resolve BaseUrl.
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
