...
public partial class Areas_Admin_Control_Project_Item_AddEditItem : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminCategory(CodeApplications.Project, TypePage.Item, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = ProjectKeyword.CapNhatBaiViet;
        ...
        {
            ltrTitle.Text = ProjectKeyword.ThemMoiBaiViet;
