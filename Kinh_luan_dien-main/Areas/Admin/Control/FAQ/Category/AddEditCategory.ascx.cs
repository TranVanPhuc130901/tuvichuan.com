...
public partial class Areas_Admin_Control_FAQ_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.FAQ, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = FAQKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = FAQKeyword.ThemMoiDanhMuc;
