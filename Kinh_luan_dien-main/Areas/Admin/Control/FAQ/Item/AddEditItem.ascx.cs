...
public partial class Areas_Admin_Control_FAQ_Item_AddEditItem : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminCategory(CodeApplications.FAQ, TypePage.Item, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = FAQKeyword.CapNhatBaiViet;
        ...
        {
            ltrTitle.Text = FAQKeyword.ThemMoiBaiViet;
