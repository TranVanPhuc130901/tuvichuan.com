...
public partial class Areas_Admin_Control_FAQ_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.FAQGroupItem;
    private readonly string _pic = FolderPic.FAQ;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.FAQ;
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.FAQ, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = FAQKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = FAQKeyword.ThemMoiNhom;
