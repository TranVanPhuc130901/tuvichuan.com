...
public partial class Areas_Admin_Control_Product_Payment_AddEditPayment : UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (_action.Equals(TypePage.CreatePayment)) _insert = true;
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Product, TypePage.Payment, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = ProductKeyword.CapNhatPhuongThucThanhToan;
        ...
        {
            ltrTitle.Text = ProductKeyword.ThemMoiPhuongThucThanhToan;
