<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_Product_Color_Index" %>
...
<div id="page-content">
    ...
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=RevosJsc.ProductControl.Link.LnkMnProductColorCreate() %>" title="Add"><i class="fa fa-plus"></i> <%=ProductKeyword.ThemMoiMau %></a>&nbsp;&nbsp;&nbsp;
