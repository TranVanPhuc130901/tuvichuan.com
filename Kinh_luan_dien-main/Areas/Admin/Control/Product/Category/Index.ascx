<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_Product_Category_Index" %>
<%@ Import Namespace="Developer.Keyword" %>
<style>
    .cot1 { width: 30px }
    .cot2 { width: calc(100% - 30px - 65px - 100px - 65px - 100px - 150px) }
    .cot3 { width: 65px }
    .cot4 { width: 100px }
    .cot5 { width: 65px }
    .cot6 { width: 100px }
...
<div id="page-content">
    ...
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=RevosJsc.ProductControl.Link.LnkMnProductCategoryCreate() %>" title="Add"><i class="fa fa-plus"></i> <%=ProductKeyword.ThemMoiDanhMuc %></a>&nbsp;&nbsp;&nbsp;
