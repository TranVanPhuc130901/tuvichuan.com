<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditCategory.ascx.cs" Inherits="Areas_Admin_Control_Product_Category_AddEditCategory" %>
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <uc1:UploadImage runat="server" id="UploadImage2" Visible="false"/>
                    <div class="form-group d-none">
                        <label class="control-label col-md-2">Link khi click banner</label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtLinkBanner" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
