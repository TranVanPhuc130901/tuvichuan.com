<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditFilter.ascx.cs" Inherits="Areas_Admin_Control_Product_Filter_AddEditFilter" %>
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">Kiểu chọn</label>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <asp:DropDownList runat="server" ID="ddlParam" CssClass="form-control">
                                <asp:ListItem Value="0" Text="Khoảng giá"></asp:ListItem>
                                <asp:ListItem Value="1" Text="Thương hiệu"></asp:ListItem>
