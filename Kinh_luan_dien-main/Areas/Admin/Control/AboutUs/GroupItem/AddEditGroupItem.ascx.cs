...
public partial class Areas_Admin_Control_AboutUs_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.AboutUsGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.AboutUs;
    ...
    {
        var listModul = new AboutUsPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.AboutUs, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = AboutUsKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = AboutUsKeyword.ThemMoiNhom;
