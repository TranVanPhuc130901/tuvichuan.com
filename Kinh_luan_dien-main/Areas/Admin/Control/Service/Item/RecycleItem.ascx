<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="Areas_Admin_Control_Service_Item_RecycleItem" %>
...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=ServiceKeyword.DanhSachBaiVietDaXoa %></li>
    </ul>
