...
public partial class Areas_Admin_Control_Service_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Service, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = ServiceKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = ServiceKeyword.ThemMoiDanhMuc;
