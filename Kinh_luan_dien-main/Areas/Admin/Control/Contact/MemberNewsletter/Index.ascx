<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_Member_NewsLetter_Index" %>
<%@ Import Namespace="Developer.Keyword" %>
<style>
    .cot1 { width: 30px }
    .cot2 { width: calc(100% - 30px - 150px - 100px - 150px) }
    .cot3 { width: 150px }
    .cot6 { width: 100px }
    .cot7 { width: 150px }
</style>
<div id="page-content">
    ...
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a class="text-danger" href="javascript:DeleteRecListMembers('<%=Action %>','<%=Pic %>');"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
        <div class="row">
            <div class="form-group col-md-4">
                <asp:TextBox runat="server" id="txtTitle" CssClass="form-control" placeholder="Tên tài khoản" Enabled="False"></asp:TextBox>
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="list-category">
            <div class="head item">
                ...
                <div class="text-center cot3"><asp:LinkButton runat="server" ID="lbtCreateDate" OnClick="lbtCreateDate_Click" ToolTip="Click để sắp xếp theo ngày đăng">Ngày tạo <i class="fa fa-sort"></i></asp:LinkButton></div>
