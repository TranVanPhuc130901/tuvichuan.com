<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_Contact_Category_Index" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=ContactKeyword.DanhSachDanhMuc %></li>
    </ul>
    <!-- END Forms General Header -->
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=RevosJsc.ContactControl.Link.LnkMnContactCategoryCreate() %>" title="Add"><i class="fa fa-plus"></i> <%=ContactKeyword.ThemMoiDanhMuc %></a>&nbsp;&nbsp;&nbsp;
            <a class="text-warning" href="javascript:DeleteListContact('<%=Control %>','<%=Action %>');"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
