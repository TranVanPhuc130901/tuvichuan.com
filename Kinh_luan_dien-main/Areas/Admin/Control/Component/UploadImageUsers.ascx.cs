...
public partial class Areas_Admin_Control_Component_UploadImageUsers : System.Web.UI.UserControl
{
    /*
     Hướng dẫn sử dụng
    ============Tại PageLoad gọi===========================
    ...
    private bool _hanCheKichThuoc = true;
    /// <summary>
    ///  Cần gán ngay tại Page_Load
    /// </summary>
    ...
    #region Hiển thị checkbox
    private bool _layAnhTuNoiDung = true;
    /// <summary>
                    ...
                    if (cbTaoAnhNho.Checked)
                    {
                        ...
                        switch (fileex.ToLower())
                        {
                            ...
                            case ".gif":
                                ...
                                break;
                            default:
                                thumb.SaveJpg(path + vimgThumb, 90);
                                break;
                        }
                    }
                    #endregion
