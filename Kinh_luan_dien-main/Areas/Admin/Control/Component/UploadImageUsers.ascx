<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UploadImageUsers.ascx.cs" Inherits="Areas_Admin_Control_Component_UploadImageUsers" %>
<asp:HiddenField ID="hdImage" runat="server" />

<div class="form-group">
    <label class="control-label col-md-3"><asp:Literal runat="server" id="ltrText"/></label>
    <div class="col-md-9">
