<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_News_Item_Index" %>
...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=NewsKeyword.DanhSachBaiViet %></li>
    </ul>
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=RevosJsc.NewsControl.Link.LnkMnNewsItemCreate() %>" title="Add"><i class="fa fa-plus"></i> <%=NewsKeyword.ThemMoiBaiViet %></a>&nbsp;&nbsp;&nbsp;
