<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditItem.ascx.cs" Inherits="Areas_Admin_Control_News_Item_AddEditItem" %>
            ...
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <asp:DropDownList runat="server" ID="ddlUser" CssClass="form-control select-chosen"/>
                        </div>
                        <label class="control-label col-md-2">Thời gian đọc (phút)</label>
                        <div class="col-md-1">
                            <asp:TextBox runat="server" ID="txtReadtime" TextMode="Number" CssClass="form-control" Text="5"></asp:TextBox>
                        </div>
