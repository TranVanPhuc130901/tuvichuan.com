...
public partial class Areas_Admin_Control_News_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.News, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = NewsKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = NewsKeyword.ThemMoiDanhMuc;
