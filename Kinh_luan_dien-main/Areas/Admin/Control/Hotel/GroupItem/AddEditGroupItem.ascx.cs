...
public partial class Areas_Admin_Control_Hotel_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.HotelGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Hotel;
    ...
    {
        var listModul = new HotelPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Hotel, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = HotelKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = HotelKeyword.ThemMoiNhom;
