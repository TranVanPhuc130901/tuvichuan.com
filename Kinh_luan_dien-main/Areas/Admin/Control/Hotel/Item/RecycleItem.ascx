<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="Areas_Admin_Control_Hotel_Item_RecycleItem" %>
...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=HotelKeyword.DanhSachBaiVietDaXoa %></li>
    </ul>
