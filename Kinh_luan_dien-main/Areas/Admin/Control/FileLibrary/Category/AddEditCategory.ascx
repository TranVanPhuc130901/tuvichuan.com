<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditCategory.ascx.cs" Inherits="Areas_Admin_Control_FileLibrary_Category_AddEditCategory" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        <li><%=FileLibraryKeyword.FileLibrary %></li>
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">Chi phí vận chuyển</label>
                        <div class="col-md-10">
                            <div class="input-group">
                                <asp:TextBox runat="server" ID="txtPriceNew" TextMode="Number" Text="0" min="0" CssClass="form-control not-reset" onkeyup="HienThiGia(this,'giaBan');" required></asp:TextBox>
