...
public partial class Areas_Admin_Control_FileLibrary_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.FileLibraryGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.FileLibrary;
    ...
    {
        var listModul = new FileLibraryPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.FileLibrary, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = FileLibraryKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = FileLibraryKeyword.ThemMoiNhom;
