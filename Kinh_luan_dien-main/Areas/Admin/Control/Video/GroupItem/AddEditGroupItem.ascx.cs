...
public partial class Areas_Admin_Control_Video_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.VideoGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Video;
    ...
    {
        var listModul = new VideoPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Video, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = VideoKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = VideoKeyword.ThemMoiNhom;
