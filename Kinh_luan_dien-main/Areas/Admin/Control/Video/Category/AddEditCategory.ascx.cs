...
public partial class Areas_Admin_Control_Video_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Video, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = VideoKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = VideoKeyword.ThemMoiDanhMuc;
