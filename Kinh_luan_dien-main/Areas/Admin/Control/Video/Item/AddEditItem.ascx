<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditItem.ascx.cs" Inherits="Areas_Admin_Control_Video_Item_AddEditItem" %>
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Mã video <span></span></label>
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtCode" CssClass="form-control" Enabled="False" required></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
