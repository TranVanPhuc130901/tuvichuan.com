...
public partial class Areas_Admin_Control_PhotoAlbum_Item_AddEditItem : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminCategory(CodeApplications.PhotoAlbum, TypePage.Item, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = PhotoAlbumKeyword.CapNhatBaiViet;
        ...
        {
            ltrTitle.Text = PhotoAlbumKeyword.ThemMoiBaiViet;
