...
public partial class Areas_Admin_Control_PhotoAlbum_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.PhotoAlbumGroupItem;
    private readonly string _pic = FolderPic.PhotoAlbum;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.PhotoAlbum;
    ...
    {
        var listModul = new PhotoAlbumPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.PhotoAlbum, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = PhotoAlbumKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = PhotoAlbumKeyword.ThemMoiNhom;
