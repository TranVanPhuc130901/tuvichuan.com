<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_Advertising_Item_Index" %>
<%@ Import Namespace="Developer.Keyword" %>
<%@ Import Namespace="RevosJsc.AdvertistmentsControl" %>
<style>
    .cot1 { width: 30px }
    .cot2 { width: calc(100% - 30px - 150px - 65px - 100px - 150px) }
    .cot3 { width: 150px }
    .cot5 { width: 65px }
    .cot6 { width: 100px }
    .cot7 { width: 150px }
...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=AdvertistmentsKeyword.DanhSachBaiViet %></li>
    </ul>
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=Link.LnkMnAdvertistmentsCreate() %>&iapid=<%=IapID %>" title="Add"><i class="fa fa-plus"></i> <%=AdvertistmentsKeyword.ThemMoiBaiViet %></a>&nbsp;&nbsp;&nbsp;
            <a class="text-warning" href="javascript:DeleteListAdvertistments();"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
        <div class="row">
        ...
        <div class="list-category">
            <div class="head item">
                ...
                <div class="text-center cot5"><asp:LinkButton runat="server" ID="lbtOrder" OnClick="lbtOrder_Click" ToolTip="Click để sắp xếp theo số thứ tự">STT <i class="fa fa-sort"></i></asp:LinkButton></div>
