<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="Areas_Admin_Control_Advertising_Item_RecycleItem" %>
<%@ Import Namespace="Developer.Keyword" %>
<style>
    .cot1 { width: 30px }
    .cot2 { width: calc(100% - 30px - 100px - 120px) }
    .cot3 { width: 100px }
    .cot5 { width: 120px }
</style>
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=AdvertistmentsKeyword.DanhSachBaiVietDaXoa %></li>
    </ul>
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a class="text-danger" href="javascript:DeleteRecListAdvertistments();"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
        <div class="row">
