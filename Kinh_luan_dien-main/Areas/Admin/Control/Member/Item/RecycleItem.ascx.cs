...
public partial class Areas_Admin_Control_News_Item_RecycleItem : System.Web.UI.UserControl
{
    protected readonly string Control = CodeApplications.Member;
    protected readonly string Action = TypePage.RecycleItem;
    ...
    private void GetList(string order)
    {
        ...
        for (var i = 0; i < dt.Rows.Count; i++)
        {
            ...
            s.Append("<a href=\"javascript:RestoreMember('" + Action + "','" + id + "','" + itemTitle + "')\"; title='Khôi phục' class='btn btn-success'><i class='gi gi-refresh'></i></a> ");
