...
public partial class Areas_Admin_Control_Cruises_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Cruises, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = CruisesKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = CruisesKeyword.ThemMoiDanhMuc;
