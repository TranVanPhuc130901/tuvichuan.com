<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditItem.ascx.cs" Inherits="Areas_Admin_Control_Blog_Item_AddEditItem" %>
...
<%@ Register Src="~/Areas/Admin/Control/Component/UploadImage1.ascx" TagPrefix="uc1" TagName="UploadImage1" %>
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <uc1:UploadImage1 runat="server" id="UploadImage1" Visible="False" />
                    <div class="form-group">
