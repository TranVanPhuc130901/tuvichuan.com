<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleCategory.ascx.cs" Inherits="Areas_Admin_Control_Blog_Category_RecycleCategory" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=BlogKeyword.DanhSachDanhMucDaXoa %></li>
    </ul>
