...
public partial class Areas_Admin_Control_Blog_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.BlogGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Blog;
    ...
    {
        var listModul = new BlogPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Blog, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = BlogKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = BlogKeyword.ThemMoiNhom;
