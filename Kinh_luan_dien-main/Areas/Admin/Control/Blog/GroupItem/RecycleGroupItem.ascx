<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleGroupItem.ascx.cs" Inherits="Areas_Admin_Control_Blog_GroupItem_RecycleGroupItem" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=BlogKeyword.DanhSachNhomDaXoa %></li>
    </ul>
