...
public partial class Areas_Admin_Control_Reviews_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.ReviewsGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Reviews;
    ...
    {
        var listModul = new ReviewsPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Reviews, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = ReviewsKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = ReviewsKeyword.ThemMoiNhom;
