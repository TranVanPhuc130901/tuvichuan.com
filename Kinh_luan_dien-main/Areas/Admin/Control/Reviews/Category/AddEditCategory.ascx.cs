...
public partial class Areas_Admin_Control_Reviews_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Reviews, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = ReviewsKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = ReviewsKeyword.ThemMoiDanhMuc;
