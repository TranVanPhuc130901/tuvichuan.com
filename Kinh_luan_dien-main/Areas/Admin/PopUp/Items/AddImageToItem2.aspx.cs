...
public partial class Areas_Admin_PopUp_Items_AddImageToItem2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        btnCancel.Attributes["href"] = "/Areas/Admin/PopUp/Items/AddImageToItem2.aspx?control=" + _control + "&subapp=" + _subApp + "&pic=" + _pic + "&iiid=" + _iiId;
    ...
    private void GetSubItems()
    {
        ...
        txtEmbed.Text = dt.Rows[0][SubitemsColumns.VsiParam].ToString();
    ...
    private void GetList()
    {
        ...
        for (var i = 0; i < dt.Rows.Count; i++)
        {
            ...
            s.Append("<a href='/Areas/Admin/PopUp/Items/AddImageToItem2.aspx?control=" + _control + "&subapp=" + _subApp + "&pic=" + _pic + "&iiid=" + _iiId + "&isiid=" + id + @"' class='btn btn-default' title='Sửa'><i class='fa fa-pencil'></i></a> ");
    ...
    protected void btSubmit_OnClick(object sender, EventArgs e)
    {
        ...
        for (var i = 0; i < listImage.Count; i++)
        {
            ...
            if (_edit)
            {
                ...
                Subitems.Update(_iiId, _lang, _subApp, txtTitle.Text, "", "", vImg, txtEmbed.Text, "", "", txtOrder.Text, status, DateTime.Now.ToString(), DateTime.Now.ToString(), _isiId);
            }
            else
            {
                Subitems.Insert(_iiId, _lang, _subApp, txtTitle.Text + (i > 0 ? " " + i : ""), "", "", vImg, txtEmbed.Text, "", "", (int.Parse(txtOrder.Text) + i).ToString(), status, DateTime.Now.ToString(), DateTime.Now.ToString());
            }
            #endregion
        ...
        {
            Response.Redirect("/Areas/Admin/PopUp/Items/AddImageToItem2.aspx?control=" + _control + "&subapp=" + _subApp + "&pic=" + _pic + "&iiid=" + _iiId);
        }
    }
}