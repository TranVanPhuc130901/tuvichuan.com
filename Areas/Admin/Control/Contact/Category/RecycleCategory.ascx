<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleCategory.ascx.cs" Inherits="Areas_Admin_Control_Contact_Category_RecycleCategory" %>
<%@ Import Namespace="Developer.Keyword" %>
<style>
    .cot1 { width: 30px }
    .cot2 { width: calc((100% - 30px - 100px - 120px) / 5 * 2) }
    .cot3 { width: calc((100% - 30px - 100px - 120px) / 5 * 3) }
    .cot4 { width: 100px }
    .cot5 { width: 120px }
</style>
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=ProductKeyword.DanhSachDanhMucDaXoa %></li>
    </ul>
    <!-- END Forms General Header -->
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a class="text-danger" href="javascript:DeleteRecListContact('<%=Control %>','<%=Pic %>');"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
