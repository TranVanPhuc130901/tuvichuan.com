...
public partial class Areas_Admin_Control_Cruises_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.CruisesGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Cruises;
    ...
    {
        var listModul = new CruisesPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Cruises, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = CruisesKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = CruisesKeyword.ThemMoiNhom;
