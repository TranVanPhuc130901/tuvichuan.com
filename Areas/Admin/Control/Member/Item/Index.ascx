<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_Member_Item_Index" %>
<%@ Import Namespace="Developer.Keyword" %>
<style>
    .cot1 { width: 30px }
    .cot2 { width: calc(100% - 30px - 150px - 150px - 100px - 150px) }
    .cot3 { width: 150px }
    .cot4 { width: 150px }
    .cot6 { width: 100px }
    .cot7 { width: 150px }
...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        <li><%=MemberKeyword.Member %></li>
        <li><%=MemberKeyword.DanhSachMember %></li>
    </ul>
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=RevosJsc.MemberControl.Link.LnkMnMemberItemCreate() %>" title="Add"><i class="fa fa-plus"></i> <%=MemberKeyword.ThemMoiMember %></a>&nbsp;&nbsp;&nbsp;
            <a class="text-warning" href="javascript:DeleteListMembers('<%=Action %>');"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
        <div class="row">
            <div class="form-group col-md-4">
                <asp:TextBox runat="server" id="txtTitle" CssClass="form-control" placeholder="Tên tài khoản"></asp:TextBox>
            </div>
            <div class="form-group col-md-4">
                <asp:TextBox runat="server" id="txtOther" CssClass="form-control" placeholder="Email hoặc sđt"></asp:TextBox>
            </div>
        ...
        <div class="list-category">
            <div class="head item">
                ...
                <div class="cot2"><asp:LinkButton runat="server" ID="lbtTitle" OnClick="lbtTitle_Click" ToolTip="Click để sắp xếp theo tiêu đề">Tài khoản <i class="fa fa-sort"></i></asp:LinkButton></div>
                ...
                <div class="text-center cot4"><asp:LinkButton runat="server" ID="lbtDateOfBirth" OnClick="lbtDateOfBirth_Click" ToolTip="Click để sắp xếp theo ngày sinh">Ngày sinh <i class="fa fa-sort"></i></asp:LinkButton></div>
