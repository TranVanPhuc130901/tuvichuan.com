...
public partial class Areas_Admin_Control_AboutUs_Item_AddEditItem : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminCategory(CodeApplications.AboutUs, TypePage.Item, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = AboutUsKeyword.CapNhatBaiViet;
        ...
        {
            ltrTitle.Text = AboutUsKeyword.ThemMoiBaiViet;
