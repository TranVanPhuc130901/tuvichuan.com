<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_AboutUs_Config_Index" %>
    ...
    <form runat="server" class="form-horizontal">
        <div class="block row">
            <div class="col-md-6">
                ...
                <fieldset>
                    <legend>Nội dung đầu trang Giới thiệu</legend>
                    <div class="form-group">
                        <div class="col-md-12">
