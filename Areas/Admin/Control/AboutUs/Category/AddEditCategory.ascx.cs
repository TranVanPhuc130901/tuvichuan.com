...
public partial class Areas_Admin_Control_AboutUs_Category_AddEditCategory : UserControl
{
    ...
    private readonly string _pic = FolderPic.AboutUs;
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.AboutUs, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = AboutUsKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = AboutUsKeyword.ThemMoiDanhMuc;
