...
public partial class Areas_Admin_Control_Service_GroupItem_AddEditGroupItem : UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Service;
    ...
    {
        var listModul = new ServicePosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Service, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = ServiceKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = ServiceKeyword.ThemMoiNhom;
