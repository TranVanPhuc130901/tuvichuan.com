...
public partial class Areas_Admin_Control_News_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.NewsGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.News;
    ...
    {
        var listModul = new NewsPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.News, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = NewsKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = NewsKeyword.ThemMoiNhom;
