<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleItem.ascx.cs" Inherits="Areas_Admin_Control_Tour_Item_RecycleItem" %>
...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=TourKeyword.DanhSachBaiVietDaXoa %></li>
    </ul>
