<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleFilter.ascx.cs" Inherits="Areas_Admin_Control_Tour_Filter_RecycleFilter" %>
...
<div id="page-content">
    ...
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a class="text-danger" href="javascript:DeleteRecListFilter('<%=Control %>','<%=Pic %>');"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
