...
public partial class Areas_Admin_Control_Tour_Filter_AddEditFilter : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Tour, TypePage.Filter, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = TourKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = TourKeyword.ThemMoiDanhMuc;
    ...
    protected void btSubmit_OnClick(object sender, EventArgs e)
    {
        ...
        if (_insert)
        {
            ...
            Filter.Insert(ddlCategory.SelectedValue, _lang, txtOrder.Text, txtTitle.Text, txtDesc.Text, image, "", txtDate.Text.Replace("T", " "), DateTime.Now.ToString(), ddlType.SelectedValue, status);
            #region Logs
        ...
        else
        {
            ...
            Filter.Update(ddlCategory.SelectedValue, _lang, txtOrder.Text, txtTitle.Text, txtDesc.Text, image, "", txtDate.Text.Replace("T", " "), DateTime.Now.ToString(), ddlType.SelectedValue, status, _ifid);
            #region Logs
            var logAuthor = CookieExtension.GetCookies(SecurityExtension.BuildPassword(UsersColumns.VuAccount));
            var logCreateDate = DateTime.Now.ToString();
