...
public partial class Areas_Admin_Control_Tour_Category_Index : System.Web.UI.UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private const string App = CodeApplications.Tour;
    ...
    private string GetCate()
    {
        ...
        for (var i = 0; i < dt.Rows.Count; i++)
        {
            ...
            if (TourConfig.ShowFillterProperties) s.Append("<a href=\"javascript:NewWindow_('" + LinkAddFilter(id) + "','ImageList','900','500','no','no')\" title=\"Thêm thuộc tính lọc\" class='btn btn-default'><i class='fa fa-filter'></i></a> ");
