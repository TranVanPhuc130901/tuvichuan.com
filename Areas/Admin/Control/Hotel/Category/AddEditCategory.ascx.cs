...
public partial class Areas_Admin_Control_Hotel_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Hotel, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = HotelKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = HotelKeyword.ThemMoiDanhMuc;
