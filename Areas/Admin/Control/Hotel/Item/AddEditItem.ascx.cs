...
public partial class Areas_Admin_Control_Hotel_Item_AddEditItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.Hotel;
    private readonly string _pic = FolderPic.Hotel;
    ...
    {
        return LinkAdmin.GoAdminCategory(CodeApplications.Hotel, TypePage.Item, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = HotelKeyword.CapNhatBaiViet;
        ...
        {
            ltrTitle.Text = HotelKeyword.ThemMoiBaiViet;
