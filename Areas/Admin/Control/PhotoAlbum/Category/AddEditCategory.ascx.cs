...
public partial class Areas_Admin_Control_PhotoAlbum_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.PhotoAlbum, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = PhotoAlbumKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = PhotoAlbumKeyword.ThemMoiDanhMuc;
