<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_Reviews_GroupItem_Index" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=ReviewsKeyword.DanhSachNhom %></li>
    </ul>
    <!-- END Forms General Header -->
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=RevosJsc.ReviewsControl.Link.LnkMnReviewsGroupItemCreate() %>" title="Add"><i class="fa fa-plus"></i> <%=ReviewsKeyword.ThemMoiNhom %></a>&nbsp;&nbsp;&nbsp;
