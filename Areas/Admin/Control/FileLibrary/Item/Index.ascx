<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_FileLibrary_Item_Index" %>
...
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=FileLibraryKeyword.DanhSachBaiViet %></li>
    </ul>
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=RevosJsc.FileLibraryControl.Link.LnkMnFileLibraryItemCreate() %>" title="Add"><i class="fa fa-plus"></i> <%=FileLibraryKeyword.ThemMoiBaiViet %></a>&nbsp;&nbsp;&nbsp;
