<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditCategory.ascx.cs" Inherits="Areas_Admin_Control_Blog_Category_AddEditCategory" %>
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <uc1:UploadImage1 runat="server" id="UploadImage1" />
                    <div class="form-group">
