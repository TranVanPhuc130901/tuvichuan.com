<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleCategory.ascx.cs" Inherits="Areas_Admin_Control_Video_Category_RecycleCategory" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=VideoKeyword.DanhSachDanhMucDaXoa %></li>
    </ul>
