...
public partial class Areas_Admin_Control_Customer_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.CustomerGroupItem;
    private readonly string _pic = FolderPic.Customer;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Customer;
    ...
    {
        var listModul = new CustomerPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Customer, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = CustomerKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = CustomerKeyword.ThemMoiNhom;
