...
public partial class Areas_Admin_Control_Customer_Item_AddEditItem : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminCategory(CodeApplications.Customer, TypePage.Item, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = CustomerKeyword.CapNhatBaiViet;
        ...
        {
            ltrTitle.Text = CustomerKeyword.ThemMoiBaiViet;
