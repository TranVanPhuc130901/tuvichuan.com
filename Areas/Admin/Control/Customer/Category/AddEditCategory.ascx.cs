...
public partial class Areas_Admin_Control_Customer_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Customer, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = CustomerKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = CustomerKeyword.ThemMoiDanhMuc;
