...
public partial class Areas_Admin_Control_Project_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.ProjectGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Project;
    ...
    {
        var listModul = new ProjectPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Project, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = ProjectKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = ProjectKeyword.ThemMoiNhom;
