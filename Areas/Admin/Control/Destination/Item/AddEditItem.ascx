<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditItem.ascx.cs" Inherits="Areas_Admin_Control_Destination_Item_AddEditItem" %>
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <uc1:UploadImage runat="server" id="UploadImage1" Visible="False" />
                    <div class="form-group">
