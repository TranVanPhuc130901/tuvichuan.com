...
public partial class Areas_Admin_Control_Destination_Item_AddEditItem : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminCategory(CodeApplications.Destination, TypePage.Item, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = DestinationKeyword.CapNhatBaiViet;
        ...
        {
            ltrTitle.Text = DestinationKeyword.ThemMoiBaiViet;
