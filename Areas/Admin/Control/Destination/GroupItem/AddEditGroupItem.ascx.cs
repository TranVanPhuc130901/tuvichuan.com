...
public partial class Areas_Admin_Control_Destination_GroupItem_AddEditGroupItem : UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.DestinationGroupItem;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UploadImage.Control = CodeApplications.Destination;
    ...
    {
        var listModul = new DestinationPosition();
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.Destination, TypePage.GroupItem);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = DestinationKeyword.CapNhatNhom;
        ...
        {
            ltrTitle.Text = DestinationKeyword.ThemMoiNhom;
