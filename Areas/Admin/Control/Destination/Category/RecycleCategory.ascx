<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleCategory.ascx.cs" Inherits="Areas_Admin_Control_Destination_Category_RecycleCategory" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=DestinationKeyword.DanhSachDanhMucDaXoa %></li>
    </ul>
