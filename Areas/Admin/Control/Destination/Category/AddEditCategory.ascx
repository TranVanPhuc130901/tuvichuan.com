<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditCategory.ascx.cs" Inherits="Areas_Admin_Control_Destination_Category_AddEditCategory" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        <li><%=DestinationKeyword.Destination %></li>
        <li><asp:Literal runat="server" id="ltrTitle"/></li>
    </ul>
    <!-- END Forms General Header -->
    <form id="form" runat="server" class="form-horizontal">
        <asp:HiddenField runat="server" ID="HdParam" />
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Link đến danh mục tour <span></span></label>
                        <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <CKEditor:CKEditorControl ID="txt_content2" Height="200"  runat="server"></CKEditor:CKEditorControl>
                                </div>
                            </div>
                        </fieldset>
                    </div>
                    <div class="col-md-6">
                        <fieldset>
                            <legend>La petite anecdote</legend>
                            <div class="form-group">
                                <div class="col-md-12">
                                    <CKEditor:CKEditorControl ID="txt_content3" Height="200"  runat="server"></CKEditor:CKEditorControl>
                                </div>
                            </div>
                        </fieldset>
                    </div>
