...
public partial class Areas_Admin_Control_Product_Payment_Index : System.Web.UI.UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private readonly string _app = CodeApplications.Payment;
    private string _txtLevel = "";
    protected readonly string Control = CodeApplications.Product;
    protected readonly string Action = TypePage.Payment;
    ...
    private string GetCate()
    {
        ...
        for (var i = 0; i < dt.Rows.Count; i++)
        {
            ...
            s.Append("<a href=\"" + LinkAdmin.GoAdminCategory(Control, TypePage.UpdatePayment, id) + "\" title=\"Chỉnh sửa\" class='btn btn-default'><i class='fa fa-pencil'></i></a> ");
