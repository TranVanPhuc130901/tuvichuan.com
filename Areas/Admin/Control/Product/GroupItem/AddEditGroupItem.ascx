<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditGroupItem.ascx.cs" Inherits="Areas_Admin_Control_Product_GroupItem_AddEditGroupItem" %>
            ...
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:DropDownList runat="server" ID="DdlPosition" CssClass="form-control select-chosen" required/>
                        </div>
                    </div>
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Tên nhóm <span></span></label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">Link khi click banner</label>
                        <div class="col-md-10">
