...
public partial class Areas_Admin_Control_Product_Color_Index : System.Web.UI.UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private const string App = CodeApplications.ProductColors;
    private string _txtLevel = "";
    protected readonly string Control = CodeApplications.Product;
    protected readonly string Action = TypePage.Color;
    ...
    private string GetCate()
    {
        ...
        for (var i = 0; i < dt.Rows.Count; i++)
        {
            ...
            s.Append("<div class=\"cot3 text-center\">--</div>");

            s.Append("<div class=\"cot4 text-center\">--</div>");
            ...
            s.Append("<a href=\"" + LinkAdmin.GoAdminCategory(Control, TypePage.UpdateColor, id) + "\" title=\"Chỉnh sửa\" class='btn btn-default'><i class='fa fa-pencil'></i></a> ");
