<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_Product_Bill_Index" %>
<%@ Import Namespace="Developer.Keyword" %>
<style>
    .cot1 { width: 30px }
    .cot2 { width: calc((100% - 30px - 150px - 100px - 150px) / 2);min-width: 250px }
    .cot3 { width: 150px }
    .cot6 { width: 100px }
    .cot7 { width: 150px }
</style>
<div id="page-content">
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=ProductKeyword.DanhSachDonHang %></li>
    </ul>
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a class="text-danger" href="javascript:DeleteListBills();"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
        <div class="row">
            ...
            <div class="form-group col-md-4">
                <asp:TextBox runat="server" id="txtCode" CssClass="form-control" placeholder="Tìm theo mã đơn hàng"></asp:TextBox>
            </div>
