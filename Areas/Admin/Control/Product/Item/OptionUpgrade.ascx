<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OptionUpgrade.ascx.cs" Inherits="Areas_Admin_Control_Product_Item_OptionUpgrade" %>
...
<div id="page-content">
    ...
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="/admin?control=Product&action=OptionUpgradeAdd" title="Add"><i class="fa fa-plus"></i> Thêm mới tùy chọn</a>&nbsp;&nbsp;&nbsp;
            <a class="text-warning" href="javascript:DeleteListItems('<%=Control %>','<%=Pic %>');"><i class="fa fa-trash-o"></i> Xóa các mục đang chọn</a>
        </div>
        <div class="row">
            <div class="form-group col-md-4">
                <asp:TextBox runat="server" id="txtTitle" CssClass="form-control" placeholder="Tìm theo tiêu đề"></asp:TextBox>
            </div>
            <div class="form-group col-md-4">
