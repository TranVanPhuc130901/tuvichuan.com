...
public partial class Areas_Admin_Control_Product_Category_Index : System.Web.UI.UserControl
{
    private readonly string _lang = RevosJsc.LanguageControl.Cookie.GetLanguageValueAdmin();
    private const string App = CodeApplications.Product;
    ...
    private string GetCate()
    {
        ...
        for (var i = 0; i < dt.Rows.Count; i++)
        {
            ...
            if (ProductConfig.ShowFilterProperties) s.Append("<a href=\"javascript:NewWindow_('"+ LinkAddFilter(id) + "','ImageList','900','500','no','no')\" title=\"Thêm thuộc tính lọc\" class='btn btn-default'><i class='fa fa-filter'></i></a> ");
