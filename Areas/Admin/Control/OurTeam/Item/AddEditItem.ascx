<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditItem.ascx.cs" Inherits="Areas_Admin_Control_OurTeam_Item_AddEditItem" %>
        ...
        <div class="block row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Điện thoại <span></span></label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Viber <span></span></label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtViber" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Zalo <span></span></label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtZalo" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Skype <span></span></label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtSkype" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Messenger <span></span></label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtMes" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">WhatsApp <span></span></label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtWhatsApp" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Facebook <span></span></label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtFacebook" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group count-this">
                        <label class="control-label col-md-2">Address <span></span></label>
                        <div class="col-md-10">
