...
public partial class Areas_Admin_Control_OurTeam_Category_AddEditCategory : UserControl
{
    ...
    {
        return LinkAdmin.GoAdminSubControl(CodeApplications.OurTeam, TypePage.Category, ddlCategory.SelectedValue);
    }
    ...
    private void InitialControlsValue(bool isInsert)
    {
        ...
        if (!isInsert)
        {
            ltrTitle.Text = OurTeamKeyword.CapNhatDanhMuc;
        ...
        {
            ltrTitle.Text = OurTeamKeyword.ThemMoiDanhMuc;
