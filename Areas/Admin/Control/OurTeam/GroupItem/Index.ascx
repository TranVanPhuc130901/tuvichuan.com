<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Index.ascx.cs" Inherits="Areas_Admin_Control_OurTeam_GroupItem_Index" %>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><%=OurTeamKeyword.DanhSachNhom %></li>
    </ul>
    <!-- END Forms General Header -->
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a href="<%=RevosJsc.OurTeamControl.Link.LnkMnOurTeamGroupItemCreate() %>" title="Add"><i class="fa fa-plus"></i> <%=OurTeamKeyword.ThemMoiNhom %></a>&nbsp;&nbsp;&nbsp;
