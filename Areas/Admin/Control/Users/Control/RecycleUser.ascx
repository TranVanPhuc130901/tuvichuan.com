<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecycleUser.ascx.cs" Inherits="Areas_Admin_Control_Users_Control_RecycleUser" %>
<div id="page-content">
    <!-- Forms General Header -->
    <ul class="breadcrumb breadcrumb-top">
        <li>Tài khoản quản trị</li>
        <li>Tài khoản đã xóa</li>
    </ul>
    <!-- END Forms General Header -->
    <form runat="server" class="block full">
        <div class="block-title pt10 pb10 pl20 pr20">
            <a class="text-success" href="javascript:RestoreListUsers();" title="Add"><i class="fa fa-refresh"></i> Khôi phục các mục đang chọn</a>&nbsp;&nbsp;&nbsp;
            <a class="text-danger" href="javascript:DeleteRecListUsers();"><i class="fa fa-trash"></i> Xóa vĩnh viễn các mục đang chọn</a>
        </div>
        <div class="row">
