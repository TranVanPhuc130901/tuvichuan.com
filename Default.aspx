...
<%@ Register Src="~/Areas/Display/Adv/AdvLeftHomePage.ascx" TagPrefix="uc1" TagName="AdvLeftHomePage" %>
<%@ Register Src="~/Areas/Display/Adv/AdvComment.ascx" TagPrefix="uc1" TagName="AdvComment" %>
<!DOCTYPE html>
<html lang="vi">
<head runat="server">
    <title>
            ...
            <div class="t_row">
                <div class="t_cell content_cell">
                    <div class="wrap">
                        ...
                        <uc1:AdvLeftHomePage runat="server" ID="AdvLeftHomePage" />
                ...
                <p>
                    ...
                    <div style="margin: 0 0 11px;">
                        ...
                        <div>
                            ...
                            <uc1:AdvComment runat="server" ID="AdvComment"/>
                            <div class="footer">
